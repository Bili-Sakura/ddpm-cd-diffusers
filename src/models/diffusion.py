...
class GaussianDiffusion(nn.Module):
    ...
    def set_new_noise_schedule(self, schedule_opt, device):
        # Map schedule names to diffusers beta_schedule names
        ...
        if schedule_name in ('linear', 'quad', 'warmup10', 'warmup50', 'const', 'jsd'):
        ...
        # Precompute values needed for the original API compatibility
        betas = self.noise_scheduler.betas.numpy()
        alphas = 1.0 - betas
